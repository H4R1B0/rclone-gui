...
enum L10n {
    ...
    static let translations: [String: [String: String]] = [
        ...
        "remote.test":                   ["ko": "연결 테스트", "en": "Test"],
        "remote.test.ok":                ["ko": "연결 성공", "en": "Connected"],
        "remote.test.fail":              ["ko": "연결 실패", "en": "Connection failed"],
        ...
        "settings.transfers.help": ["ko": "동시에 전송할 파일 수. 높을수록 빠르지만 메모리/대역폭을 더 사용합니다. (기본값: 4)", "en": "Number of files to transfer simultaneously. Higher is faster but uses more memory/bandwidth. (default: 4)"],
        "settings.checkers":    ["ko": "동시 체크 수 (Checkers)", "en": "Concurrent Checkers"],
        "settings.checkers.help": ["ko": "전송 전 파일을 비교/확인하는 동시 작업 수. 동기화 시 파일 변경 여부를 체크합니다. (기본값: 8)", "en": "Number of concurrent workers that check files before transfer. Used to compare files during sync. (default: 8)"],
        "settings.multiThread": ["ko": "멀티스레드 스트림", "en": "Multi-thread Streams"],
        "settings.multiThread.help": ["ko": "단일 파일을 여러 스트림으로 분할 다운로드. 대용량 파일 전송 시 속도가 향상됩니다. 0이면 비활성화. (기본값: 4)", "en": "Split a single file download into multiple streams. Improves speed for large files. 0 to disable. (default: 4)"],
        "settings.bufferSize":  ["ko": "버퍼 크기", "en": "Buffer Size"],
        "settings.bufferSize.help": ["ko": "파일 전송 시 사용할 메모리 버퍼 크기. 크게 설정하면 속도가 향상되지만 메모리를 더 사용합니다. (예: 16M, 64M, 기본값: 16M)", "en": "Memory buffer size per file transfer. Larger values improve speed but use more memory. (e.g. 16M, 64M, default: 16M)"],
        "settings.bwLimit":     ["ko": "대역폭 제한", "en": "Bandwidth Limit"],
        "settings.bwLimit.help": ["ko": "전송 대역폭 상한. 비워두면 무제한. (예: 10M = 10MB/s, 1G = 1GB/s)", "en": "Maximum bandwidth for transfers. Leave empty for unlimited. (e.g. 10M = 10MB/s, 1G = 1GB/s)"],
